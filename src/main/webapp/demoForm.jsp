...
<!-- Mirrored from preschool.dreamguystech.com/template/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Jan 2023 06:23:56 GMT -->
<head>
<meta charset="utf-8">
<meta name="viewport"
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<ul class="nav user-menu">
				<li class="nav-item dropdown language-drop me-2"><a href="#"
					class="dropdown-toggle nav-link header-nav-list"
					data-bs-toggle="dropdown"> <img
						src="assets/img/icons/header-icon-01.svg" alt="">
				</a>
				...
				<li class="nav-item zoom-screen me-2"><a href="#"
					class="nav-link header-nav-list"> <img
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li><a href="index.html"><i class="fas fa-holly-berry"></i>
								<span>Holiday</span></a></li>
						<li><a href="index.html"><i class="fas fa-comment-dollar"></i>
								<span>Fees</span></a></li>
						<li><a href="index.html"><i class="fas fa-clipboard-list"></i>
								<span>Exam list</span></a></li>
						<li><a href="index.html"><i class="fas fa-calendar-day"></i>
								<span>Events</span></a></li>
						<li><a href="index.html"><i class="fas fa-table"></i> <span>Time
									Table</span></a></li>
						<li><a href="index.html"><i class="fas fa-book"></i> <span>Library</span></a>
						</li>
						<li class="submenu"><a href="#"><i
								class="fa fa-newspaper"></i> <span> Blogs</span> <span
								class="menu-arrow"></span> </a>
							<ul>
						...
						<li><a href="blank-page.html"><i class="fas fa-file"></i>
						...
						<li class="submenu"><a href="#"><i
								class="fab fa-get-pocket"></i> <span>Base UI </span> <span
								class="menu-arrow"></span></a>
							<ul>
						...
						<li class="submenu active"><a href="#"><i
								data-feather="box"></i> <span>Elements </span> <span
								class="menu-arrow"></span></a>
							<ul>
								...
								<li><a href="horizontal-timeline.html">Horizontal
										Timeline</a></li>
								<li><a href="form-wizard.html" class="active">Form
										Wizard</a></li>
							</ul></li>
						<li class="submenu"><a href="#"><i
						...
						<li class="submenu"><a href="#"><i data-feather="award"></i>
						...
						<li class="submenu"><a href="javascript:void(0);"><i
								class="fas fa-code"></i> <span>Multi Level</span> <span
								class="menu-arrow"></span></a>
							<ul>
											...
											<li class="nav-item"><a href="#progress-seller-details"
												class="nav-link" data-toggle="tab">
													<div class="step-icon" data-bs-toggle="tooltip"
														data-bs-placement="top" title="User Details">
														<i class="far fa-user"></i>
													</div>
											</a></li>
											<li class="nav-item"><a
												href="#progress-company-document" class="nav-link"
												data-toggle="tab">
													<div class="step-icon" data-bs-toggle="tooltip"
														data-bs-placement="top" title="Address Detail">
											...
											<div class="tab-pane" id="progress-seller-details">
												...
												<form>
													<div class="row">
														...
														<div class="col-lg-6">
															<div class="mb-3">
																<label for="progresspill-lastname-input">Last
																	name</label> <input type="text" class="form-control"
													...
													<div class="row">
														<div class="col-lg-6">
															<div class="mb-3">
																<label for="progresspill-phoneno-input">Phone</label> <input
														...
														<div class="col-lg-6">
															<div class="mb-3">
																<label for="progresspill-email-input">Email</label> <input
															...
															<div class="col-lg-6">
																<div class="mb-3">
																	<label for="progresspill-vatno-input"
																		class="form-label">Address Line 2</label> <input
																		type="text" class="form-control"
															...
															<div class="col-lg-6">
																<div class="mb-3">
																	<label for="progresspill-cstno-input"
																		class="form-label">Landmark</label> <input type="text"
																		class="form-control" id="progresspill-cstno-input">
																</div>
															</div>
															<div class="col-lg-6">
																<div class="mb-3">
											...
											<div class="tab-pane" id="progress-bank-detail">
												<div>
													...
													<ul class="pager wizard twitter-bs-wizard-pager-link">
														...
														<li class="previous "><a href="javascript: void(0);"
															class="btn btn-primary me-2" onclick="nextTab()"><i
																class="bx bx-chevron-left me-2 "></i> Previous</a></li>
				...
				<div class="modal-body">
					<div class="text-center">
						...
						<button type="button" class="btn btn-primary w-md"
							data-bs-dismiss="modal" onclick="nextTab()">Save changes</button>
					</div>
				</div>
			</div>
		</div>
...
<!-- Mirrored from preschool.dreamguystech.com/template/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Jan 2023 06:24:00 GMT -->
</html>