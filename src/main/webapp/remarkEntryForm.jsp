						...
						<div class="row p-3">
							...
							<div class="col-md-2">
								<div class="form-group text-center">
									...
									<div>
									<input type="text"  class="form-control" placeholder="Enter Remark Name..">
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group text-center">
									...
									<div>
									<input type="text"  class="form-control" placeholder="Enter Remark  Minimum %">
									</div>								
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group text-center">
									...
									<div>
									<input type="text"  class="form-control" placeholder="Enter Remark Maximum %">
									</div>
								</div>
							</div>
