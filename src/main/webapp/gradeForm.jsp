				...
				<div class=" col-md-12">
						...
						<div class="row p-3">
							...
							<div class="col-md-3">
								<div class="form-group text-center">
									...
									<div>
									<input type="text"  class="form-control" placeholder="Enter Grade Min. Marks..">
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group text-center">
									...
									<div>
									<input type="text"  class="form-control" placeholder="Enter Grade Maxi. Marks..">
									</div>
								</div>
							</div>
					...
					<div class="card">
						...
						<div class="row p-3">
							...
							<div class="col-lg-3 col-md-3 col-sm-3">
								<div class="form-group text-center">
									<label class="fw-bold"> Enter Grade Name </label> 
									<div>
