		...
		<div class="page-wrapper">
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h3 class="page-title">Religion Form</h3>
							<ul class="breadcrumb">
								...
								<form action="./DB/religionDB.jsp" class="needs-validation"
									...
									<div class="form-group">
										<label for="validationCustom01"> Religion Name</label> <input
											type="text" class="form-control" name="religionName"
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							...
							<h5 class="card-title">Religion Details -</h5>
						</div>
						<div class="card-body">
								...
								<table class=" mb-0 table table-striped ">
									...
									<tbody>
										...
										<tr>
											...
											<td class="">
												<div class="actions ">
													<a href="updateReligion.jsp?id=<%=rs.getInt("religionId")%>"
