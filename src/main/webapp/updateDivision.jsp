					...
					<div class="col-md-8">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Update Division Details -</h5>
							</div>
							<div class="card-body">
								<%
								...
								rs.next();
								%>
								<form action="DB/updateDivisionDB.jsp?id=<%=id%>"
									method="post">
									<div class="form-group row">
										<label> Division Name</label> <input type="text" name="divisionName"
											value="<%=rs.getString("division")%>" class="form-control">
									</div>
