					...
					<div class="col-md-8">
						<div class="card">
							...
							<div class="card-body">
								...
								ResultSet rs = stmt.executeQuery("select * from staffRole where staffRoleId=" + id + ";");
								rs.next();
								%>
								<form action="DB/updateStaffRoleDB.jsp?id=<%=id%>"
									method="post">
									<div class="form-group row">
										<label> Section Name</label> <input type="text" name="sectionName"
											value="<%=rs.getString("staffRole")%>" class="form-control">
									</div>
									...
									<div class="form-group row">
										<label for="validationCustom01">Status</label> <select
											...
											name="status" value="<%=rs.getString("staffRoleStatus")%>">
