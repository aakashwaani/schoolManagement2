														...
														<div class="row">
															<div class="col-xl-4">
																<div class="form-group row">
																	<label for="validationCustom01"
																		class="col-form-label col-lg-3"><span
																		class="px-1"><i class="fas fa-user"></i></span>
																		Student PRN Number -</label>
																	<div class="col-lg-12">
															...
															<div class="col-xl-4">
																<div class="form-group row">
																	<label for="validationCustom01"
																		...
																		Admission -</label>
																	<div class="col-lg-12">
																		<input type="date" name="studentadmissionDate"
																			class="form-control" id="validationCustom01" required>
																		<div class="valid-feedback">Looks good!</div>
																		<div class="invalid-feedback">Please Provide
															...
															<div class="col-xl-4">
																<div class="form-group row">
																	...
																	<div class="col-lg-12">
																		<input type="date" name="studentDateofbirth"
																			class="form-control" id="validationCustom01" required>
																		<div class="valid-feedback">Looks good!</div>
																		<div class="invalid-feedback">Please Provide
															...
															<div class="col-xl-4">
																<div class="form-group row">
																	<label for="validationCustom01"
																		...
																		-</label>
																	<div class="col-lg-12">
																		<input type="email" name="studentNationality"
																			class="form-control" id="validationCustom01" required>
																		<div class="valid-feedback">Looks good!</div>
																		<div class="invalid-feedback">Please Provide
													...
													<form action="" enctype="multipart/form-data" method="POST"
															...
															<div class="col-xl-4">
																<div class="form-group row">
																	<label for="validationCustom01"
																		...
																		PRN No -</label>
																	<div class="col-lg-12">
																		<input type="email" name="studentPRN"
																			class="form-control" id="validationCustom01" required>
																		<div class="valid-feedback">Looks good!</div>
																		<div class="invalid-feedback">Please Provide
																			Student PRN No.</div>
														...
														<div class="row">
															<div class="col-xl-4">
																<div class="form-group row">
																	<label for="validationCustom01"
																		class="col-form-label col-lg-3"><span
																		class="px-1"><i class="fas fa-calendar-days"></i></span>Date
																		Of Admission-</label>
																	<div class="col-lg-12">
														...
														<div class="row">
															...
															<div class="col-xl-4">
																<div class="form-group row">
																	...
																	<div class="col-lg-12">
																		<select class="form-control form-select"
																			name="religion" id="validationCustom01" required>
																			<option></option>
																			<option></option>
																			<option></option>
																		</select>
														...
														<div class="col-xl-6">
															<div class="form-group row">
																<label for="validationCustom01"
																	class="col-form-label col-lg-3"><span
																	class="px-1"><i class="fas fa-school"></i></span>Name
																	Of Previous School -</label>
																<div class="col-lg-12">
															...
															<div class="col-xl-4">
																<div class="form-group row">
																	<label for="validationCustom01"
																		class="col-form-label col-lg-3"><span
																		class="px-1"><i
																			class="fas fa-mobile-android-alt"></i></span>Parent's
																		Contact No(Father) -</label>
																	<div class="col-lg-12">
																		<input type="number" name="studentAdharNumber"
																			class="form-control" id="validationCustom01" required>
																		<div class="valid-feedback">Looks good!</div>
															...
															<div class="col-xl-4">
																<div class="form-group row">
																	<label for="validationCustom01"
																		...
																		class="px-1"><i
																			class="fa-solid fa-calendar-days"></i></span>Academic Year -
																	</label>
																	<div class="col-lg-12">
