				...
				<div class=" col-md-12">
					<div class="card">
						...
						<table class="table table-bordered">
							<thead>
							<tr>
							<th class="card-title"> <a href="#" class="btn btn-primary btn-sm"> Prerequisite </a>
							Following steps are needed to perform operation in next academic year- </th>
							</tr>
							</thead>
						</table>
						</div>
						...
						<table class="table table-bordered">
							<thead>
								...
								<tr>
									...
									<td class="text-center"> <a href="#" class="btn btn-success btn-sm"><i class="fa-solid fa-square-caret-right"></i> </a> </td>
								</tr>
