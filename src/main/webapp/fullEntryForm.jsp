					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">New Student (Full Entry Form)</h5>
							</div>
									...
									<div class="row">
										<div class="col-xl-4">
											...
											<div class="form-group row">
												<label for="validationCustom01"
													class="col-lg-3 col-form-label"><span class="px-1"><i
														class="fa-solid fa-address-card"></i></span>Online Registered ID -</label>
												<div class="col-lg-12">
											...
											<div class="form-group row">
												...
												<div class="col-lg-12">
													<input type="number" class="form-control" name="PRNNumber"
														id="validationCustom01" required>
													<div class="valid-feedback">Looks good!</div>
													<div class="invalid-feedback">Please Provide PRN Number.</div>
